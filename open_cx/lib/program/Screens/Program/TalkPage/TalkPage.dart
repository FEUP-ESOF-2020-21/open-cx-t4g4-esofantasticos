...
import '../FeedTheForm/RatingView.dart';
        ...
        actions: <Widget>[
          FlatButton(
            ...
            onPressed: () => Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        QuestionsPage(widget.talk, MyController()))),
          )
        ],
      ),
      body: Container(
        child: ListView(
          children: <Widget>[
            ...
            ShowRating(widget.talk, MyController()),
          ],
        ),
      ),
    );
...
Widget showDescription(Talk talk) {
  return Column(
    ...
    children: <Widget>[
      ...
      Container(
        padding: EdgeInsets.only(top: 20, bottom: 20, left: 20.0, right: 15.0),
        child: Text(
          talk.information,
