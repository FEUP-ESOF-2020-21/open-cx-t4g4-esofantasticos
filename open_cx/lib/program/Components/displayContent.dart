...
import 'package:open_cx/program/Screens/Program/Askkit/Controllers/MyController.dart';
    ...
    child: GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute<Null>(
            builder: (context) => TalkPage(talk: talk)));
      },
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(talk.information, overflow: TextOverflow.ellipsis, maxLines: 2)
          ],
        ),
      ),
    ),
